   ...
   @include('nav')
        ...
        <div id="carouselExample" class="carousel slide" data-aos="fade-left" data-aos-duration="1000" >
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="images/indust.jpeg" class="d-block w-100"  alt="..." id="crousal">
                </div>
    ...
    <div id="hero-categories">
        ...
        <section id="info-section">
            <h4 data-aos="slide-right" data-aos-duration="1000" data-aos-mirror="true" > <strong >Categories><em>Industrial Lighting</em></strong></h4>
            <h1 data-aos="slide-left" data-aos-duration="1000" data-aos-mirror="true" > <strong>Industrail Lighting<strong></h1>
