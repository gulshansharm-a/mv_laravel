  ...
  @include('nav')
        ...
        <div id="carouselExample" class="carousel slide" data-aos="fade-left" data-aos-duration="1000" >
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="images/solar.png" class="d-block w-100"  alt="..." id="crousal">
                </div>
    ...
    <div id="hero-categories">
        ...
        <section id="info-section">
            <h4 data-aos="slide-right" data-aos-duration="1000" data-aos-mirror="true" > <strong >Categories><em>Solar Lighting</em></strong></h4>
            <h1 data-aos="slide-left" data-aos-duration="1000" data-aos-mirror="true" > <strong>Solar Lighting<strong></h1>
