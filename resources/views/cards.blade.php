...
<body>
  ...
  <div style="display:flex; flex-wrap:wrap; align-items:center; gap: 1rem;">
    <!-- Card 1 -->
    <div class="bg-white rounded-lg shadow-lg  overflow-hidden  mt-1" style="height:190px" id="card-width-fix">
      <div class="grid grid-cols-2 h-full">
        <div class="p-3 rock" style="margin-top: 15px;" >
          <h2 class="text-base font-bold text-blue-700">COMMERCIAL LIGHTING</h2>
    ...
    <!-- Card 2 -->
    <div class="bg-white rounded-lg shadow-lg  overflow-hidden  mt-1" style="height:190px">
      <div class="grid grid-cols-2 h-full">
        <div class="p-3 rock" style="margin-top: 15px;" >
          <h2 class="text-base font-bold text-blue-700">COMMERCIAL LIGHTING</h2>
          <p class="mt-1 text-xs text-black">Best and affordable LED Lamps</p>
